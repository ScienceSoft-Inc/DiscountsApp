...
namespace ScnDiscounts.Views
{
    class MainPage : SideBarPage
    {
            ...
            : base(typeof(MainViewModel), typeof(MainContentUI))
        {
            ...
            appBar.BtnRight.WidthRequest = 48;
            appBar.BtnRight.HeightRequest = 48;
            ...
            appBar.BtnLeft.WidthRequest = 48;
            appBar.BtnLeft.HeightRequest = 48;
            ...
            menuView.RowHeight = Device.OnPlatform(50, 40, 50);
            menuView.SeparatorVisibility = SeparatorVisibility.None;
            menuView.ItemTemplate = new DataTemplate(() => new MenuViewTemplate(contentUI));
        ...
        {
            public MenuViewTemplate(MainContentUI parentContentUI)
            {
